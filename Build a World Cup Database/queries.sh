...
echo $($PSQL "SELECT DISTINCT name FROM teams JOIN games ON teams.team_id=games.winner_id WHERE year=2018 AND winner_goals=(SELECT MAX(winner_goals) FROM games WHERE year=2018)")
